...
| `manuscript/supplementary_cobidas.md` | Supplement S4: the COBIDAS reporting checklist for `draft_v2.md` (reported / not applicable / not reported, with locations) |
...
| `notes/` | the three adversarial reviews (`adversarial_review_*.md`), the verification of the correction note (`verification_correction_note_2026-09-15.md`), the venue and preprint options (`venue_options.md`), the review computations (`rev_*.py`, `review_*.py`, `review_computations_2026-09-14.md`), the Part B plans and notes (`partB_prespec_2026-09-14.md`, `partB*.md`) and their scripts (`partB*.py`); result files, tables and logs under `notes/review_results/` |
