...
second and third adversarial reviews). `manuscript/draft.md` is the
...
| `manuscript/figures/` | `fig1_v2`–`fig4_v2` (pdf, png) and `captions_v2.md`, generated by `scripts/15_figures_v2.py`; the `draft.md` figures and `captions.md` (from `scripts/12_figures.py`) are kept in place |
...
"Part B, items 6–8" and "Correction note, 15 Sep 2026"), written after the
