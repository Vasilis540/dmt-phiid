...
second and third adversarial reviews and the verification of the correction note). `manuscript/draft.md` is the
...
| `notes/` | the three adversarial reviews (`adversarial_review_*.md`), the review computations (`rev_*.py`, `review_*.py`, `review_computations_2026-09-14.md`), the Part B plans and notes (`partB_prespec_2026-09-14.md`, `partB*.md`) and their scripts (`partB*.py`); result files, tables and logs under `notes/review_results/` |
...
"Part B, items 6–8", "Correction note, 15 Sep 2026" and "Leave-two-out"), written after the
